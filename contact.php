				...
				<?php 
					...
					<form action="proses-komentar.php" method="post">
						<table class="table table-hover">
							...
							<tr>
								<td>No Handphone
								<input type="No Handphone" name="No Handphone" class="form-control input-md" placeholder="Isikan No Handphone yang masih aktif" required>
								</td>
							</tr>
							<tr>
								<td>komentar
								<textarea name="komentar" class="form-control input-md" required> </textarea>
								</td>
							</tr>
							<tr>
								<td>
